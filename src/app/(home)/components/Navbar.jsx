    ...
    <nav className="p-[10px] text-sm text-primary-light flex justify-between items-center">
      ...
      <div className="flex items-center">
        ...
        <Link
          ...
          data-tooltip-id="search-labs"
          data-tooltip-content="Search Labs"
        ...
        <div
          ...
          data-tooltip-content="Google apps"
          data-tooltip-place="bottom"
          className="cursor-pointer ml-3 h-[40px] w-[40px] rounded-full flex justify-center items-center hover:bg-[#f0f1f1] transition-all ease-in"
        >
          <svg
            fill="#444746"
            focusable="false"
